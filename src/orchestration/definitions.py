...
from .defs.assets.ipums_full_count_census import ipums_full_count_table_raw, crosswalk_hist_id_to_hist_census_place_table_raw, ipums_full_count_table_clean, crosswalk_hist_id_to_hist_census_place_table_clean, ipums_full_count_census_with_census_place_id, ipums_full_count_census_with_census_place_id_all_years, census_place_population, ipums_full_count_individual_migration, census_place_migration
from .defs.assets.source_assets import usa_hist_census_place_population, usa_hist_census_place_migration, usa_nhgis_census_place_population_1990_2020, usa_nhgis_census_place_geom, usa_hist_census_place_geom, usa_states_geom
...
defs = Definitions(
    assets=[
        ...
        usa_nhgis_census_place_population_1990_2020,
        usa_nhgis_census_place_geom,
        usa_hist_census_place_geom,
        usa_states_geom
    ],
    resources={
