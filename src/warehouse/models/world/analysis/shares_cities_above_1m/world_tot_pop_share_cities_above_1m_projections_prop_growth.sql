...
rank_size_slopes_projections_prop_growth AS (
    {{ get_rank_size_slopes_projections('size_growth_slope_projection_prop_growth') }}
),
rank_size_slopes_prop_growth AS (
    SELECT  country, 
            year, 
            analysis_id, 
            rank_size_slope
    ...
    SELECT  country, 
            ...
            analysis_id, 
            rank_size_slope
    FROM rank_size_slopes_projections_prop_growth
),
urban_population_share_in_cities_above_1m_prop_growth_projections AS (
    {{ get_population_share_cities_above_1m_projections('rank_size_slopes_prop_growth') }}
),
total_population_share_in_cities_above_1m_prop_growth_projections AS (
    SELECT  country, 
            year, 
            analysis_id, 
            ...
            population
    FROM urban_population_share_in_cities_above_1m_prop_growth_projections
